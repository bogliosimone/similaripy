...
For a more in-depth, end-to-end example with SimilariPy, see the notebook:
**[MovieLens 32M Item-Item Recommender](notebooks/movielens32m_item_item_recommender.ipynb)**.
